...
public class NavigationView extends View {
	...
	private void init() {
		...
		text.setColor(Color.WHITE); text.setTextSize(15);
...
//		lines.setStrokeWidth(2);
		...
		if (!firstDraw) {
	        ...
	        text.setTextSize(20);
			canvas.drawText("N", cxCompass - text.getTextSize() / 2, cyCompass
					- (radiusCompass + 3 * lines.getStrokeWidth()), text);

			Rect rect = new Rect(495, 95, 495 + 85, 95 + 85);
	        final RectF rectF = new RectF(rect);
	        canvas.drawRoundRect(rectF, 5, 5, lines);
			text.setTextSize(48);
			canvas.drawText("22º13 45", 500, 100, text);
		}
	}
